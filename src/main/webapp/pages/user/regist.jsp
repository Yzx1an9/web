		...
		<script type="text/javascript">
			...
			$(function () {
				$("#username").blur(function () {
					var serialize = $("#username").serialize();
					$.getJSON("${basepath}userservlet","action=isUseful&" + serialize,function (data) {
						if(data.isUseful){
				...
				$("#sub_btn").click(function () {
					...
					//2 创建正则表达式对象
					var usernamePatt = /^[a-zA-Z]\w{5,17}$/;
					//3 使用test方法验证
					if (!usernamePatt.test(usernameText)) {
						//4 提示用户结果
						$("span.errorMsg").text("用户名不合法！必须字母开头且大于6位小于12位");
						return false;
					}
						...
						<div class="login_box">
							...
							<div class="form">
								<form action="userservlet" method="post">
									...
									<img id="code_img" alt="" src="captcha.jpg" style="	float: right; margin-right: 40px;width: 110px;height: 30px;">
									<br />
									<br />
